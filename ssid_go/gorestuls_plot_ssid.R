...
results_rdata = "ssid_go_results.rdata"
out_dir = "outputs"
...
GO_terms_list <- lst(turquoiseMFresults, turquoiseBPresults, turquoiseCCresults, greenMFresults, greenBPresults, greenCCresults,
